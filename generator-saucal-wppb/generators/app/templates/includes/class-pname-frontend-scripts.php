...
class PName_Frontend_Scripts {
	...
	public static function get_styles() {
		...
		return apply_filters( 'plugin_name_enqueue_styles', array(
			'<%= pluginSlug %>-general' => array(
				'src'     => str_replace( array( 'http:', 'https:' ), '', PNameSingleton()->plugin_url() ) . '/assets/css/<%= pluginSlug %>' . $suffix . '.css',
				'deps'    => '',
	...
	public static function load_scripts() {
		...
		self::enqueue_script( '<%= pluginSlug %>', $frontend_script_path . '<%= pluginSlug %>' . $suffix . '.js', array( 'jquery', 'jquery-blockui' ) );
